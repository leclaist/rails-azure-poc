...
# docker build -t rails_azure_poc .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name rails_azure_poc rails_azure_poc
...
EXPOSE 3000
ENV PORT=3000 RAILS_LOG_TO_STDOUT=1
